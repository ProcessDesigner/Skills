  ...
  return (
    <div className="flex">
      ...
      <div className="flex-1">
        {/* Header Section */}
        <Header />
        <header className="fixed top-0 right-0 left-64 bg-white shadow-sm z-50"> {/* Adjusted left offset */}
          <div className="flex items-center justify-between px-6 h-20"> {/* Fixed height */}
            <div className="flex items-center">
              <h1 className="text-xl font-bold">SkillHub</h1>
            </div>
            <nav className="hidden md:flex space-x-6">
              {["dashboard", "practice", "tests", "contact"].map((section) => (
                <button
                  key={section}
